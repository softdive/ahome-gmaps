...
public class PlaceSearchRequest extends JsObject {

    public PlaceSearchRequest() {
        jsObj = JsoHelper.createObject();
    }

    protected PlaceSearchRequest(JavaScriptObject peer) {
        jsObj = peer;
    }
    ...
    public void setMaxPriceLevel(double value) {
        JsoHelper.setAttribute(jsObj, "maxPriceLevel", value);
    }

    public void setMinPriceLevel(double value) {
        JsoHelper.setAttribute(jsObj, "minPriceLevel", value);
    }
    ...
    public void setOpenNow(boolean value) {
        JsoHelper.setAttribute(jsObj, "openNow", value);
    }
    ...
    public void setRankBy(String value) {
        JsoHelper.setAttribute(jsObj, "rankBy", value);
    }
