...
public enum TravelMode {
  ...
  public static native TravelMode fromValue(String value) /*-{
		...
		case $wnd.google.maps.TravelMode.BICYCLING:
			return @com.ait.toolkit.gmaps.client.services.TravelMode::BICYCLING;

		case $wnd.google.maps.TravelMode.DRIVING:
			return @com.ait.toolkit.gmaps.client.services.TravelMode::DRIVING;

		case $wnd.google.maps.TravelMode.WALKING:
			return @com.ait.toolkit.gmaps.client.services.TravelMode::WALKING;
		}
  }-*/;
