...
public class Time extends JsObject {

    protected Time(JavaScriptObject peer) {
        jsObj = peer;
    }
    ...
    public JsDate getValue() {
        return JsoHelper.getAttributeAsJavaScriptObject(jsObj, "value").cast();
    }
    ...
    public void setTimeZone(String value) {
        JsoHelper.setAttribute(jsObj, "time_zone", value);
    }

    public String getTimeZone() {
        return JsoHelper.getAttribute(jsObj, "time_zone");
    }
}
