...
public class PanoramioLayerOptions extends JsObject {

    public PanoramioLayerOptions() {
    ...
    public native void setSuppresInfoWindow(boolean value)/*-{
		var obj = this.@com.ait.toolkit.core.client.JsObject::getJsObj()();
		obj.suppressInfoWindow = value;
    }-*/;
